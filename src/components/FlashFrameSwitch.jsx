...
/>
        <div className="bb8-toggle__container">
          ...
          <div className="ff-label ff-label-left">
  ⚡ WORKSPACE
</div>

<div className="ff-label ff-label-right">
  🕒 HISTORY
</div>
          <div className="bb8">
...
.ff-label-right {
  ...
  .bb8-toggle__checkbox:not(:checked)
  + .bb8-toggle__container
  .ff-label-right {
    opacity: .35;
  }
...
export default FlashFrameSwitch;
